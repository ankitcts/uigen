...
test("createImportMap includes React CDN imports", () => {
  ...
  expect(parsed.imports).toHaveProperty("react-dom", "https://esm.sh/react-dom@19?external=react");
  expect(parsed.imports).toHaveProperty("react-dom/client", "https://esm.sh/react-dom@19/client?external=react");
